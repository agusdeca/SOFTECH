...
namespace CapaDatos
{
    public class CD_Venta
    {
        ...
        public bool Registrar(Venta obj, DataTable DetalleVenta, out string Mensaje)
        {
            ...
            try
            {
                using (SqlConnection oconexion = new SqlConnection(Conexion.cadena))
                {
                    ...
                    cmd.Parameters.AddWithValue("DocumentoCliente", obj.DocumnentoCliente);
                    ...
                    using (SqlDataReader dr = cmd.ExecuteReader())
                    {
                        ...
                        while (dr.Read())
                        {
                            obj = new Venta()
                            {
                                ...
                                DocumnentoCliente = dr["DocumentoCliente"].ToString(),
        ...
        //public List<DetalleIngreso> ObtenerDetalleVenta(int idVenta)
        //{
